...
!!!warning Warning
A lot has changed from version 2, if you have any errors, please take a look [here](getting_started/migrating_to_v3).
!!!
...
- **Edit settings**: You can edit torrent client settings directly from the bot
