...
@Client.on_callback_query(filters=custom_filters.delete_one_filter)
...
@Client.on_callback_query(filters=custom_filters.delete_one_no_data_filter)
...
@Client.on_callback_query(filters=custom_filters.delete_one_data_filter)
