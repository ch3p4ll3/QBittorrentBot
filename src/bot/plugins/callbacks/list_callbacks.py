...
@Client.on_callback_query(custom_filters.list_filter)
...
@Client.on_callback_query(custom_filters.list_by_status_filter)
...
@Client.on_callback_query(custom_filters.menu_filter)
