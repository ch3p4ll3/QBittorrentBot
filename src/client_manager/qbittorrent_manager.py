...
class QbittorrentManager(ClientManager):
    ...
    def add_magnet(self, magnet_link: Union[str, List[str]], category: str = None) -> bool:
        ...
        with qbittorrentapi.Client(**self.settings.client.connection_string) as qbt_client:
    ...
    def get_torrent(self, torrent_hash: str, status_filter: str = None) -> Union[Torrent, None]:
    ...
    def get_torrents(self, torrent_hash: str = None, status_filter: str = None) -> List[Torrent]:
